...
<body>
	...
	<section>
        <div class="main_wrapper">
	      	...
	      	<br><br>
	      	<div class="status">
	      		<h4 style="color:white; padding:5px 5px;">진행중</h4>
	      	</div>
	      	<br>
	      	<h4 style="margin-left:460px;">나이키 에어 조던1 레트로 하이<br> OG 쉐도우 2.0 gs 575441-035</h4>
	      	<br><h4 style="margin-left:460px;">Gain | RAFFLE_230131</h4><br><br>
	      	<div class="endDate">
	      		<br>
	      		<h3 style="margin-left:50px; color:lightgray;">2월 15일(수) 당첨자 발표 예정</h3>
	      	</div>
